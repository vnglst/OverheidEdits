...
describe('anon', function () {
  ...
  describe('compareIps ipv6', function () {
    ...
    it('greater than', () =>
      assert.equal(
        1,
        compareIps(
          '2600:8:b380:3f3:540b:fdbf:bc5:a6bf',
  ...
  describe('isIpInRange ipv4', function () {
    it('ip in range', () =>
      assert.isTrue(
        isIpInRange('123.123.123.123', ['123.123.123.0', '123.123.123.255']),
      ))
    it('ip less than range', () =>
      assert.isFalse(
        isIpInRange('123.123.122.123', ['123.123.123.0', '123.123.123.123']),
      ))
    it('ip greater than range', () =>
      assert.isFalse(
        isIpInRange('123.123.123.123', ['123.123.123.0', '123.123.123.122']),
      ))
    it('ip in cidr range', () =>
  ...
  describe('isIpInRange ipv6', function () {
    it('ipv6 in range', () =>
      assert.isTrue(
        isIpInRange('0000:0000:0000:0000:0000:0000:0000:0001', [
    ...
    it('ipv6 in ipv6 cidr', () =>
      assert.isTrue(
        isIpInRange(
          '0000:0000:0000:0000:0000:0000:1000:0005',
  ...
  describe('isIpInAnyRange', function () {
    ...
    it('false positive not in ranges #12', function () {
      assert.isFalse(
        isIpInAnyRange('199.19.250.20', [
          ['199.19.16.0', '199.19.27.255'],
          ['4.42.247.224', '4.42.247.255'],
        ]),
      )
      assert.isFalse(
        isIpInAnyRange('39.255.255.148', [
          ['40.0.0.0', '40.127.255.255'],
          ['40.144.0.0', '40.255.255.255'],
        ]),
      )
    })
  })
  ...
  describe('takeScreenshot', function () {
    it('works', function (done) {
      this.timeout(20000)
      const url =
        'https://en.wikipedia.org/w/index.php?diff=619968907&oldid=619663144'
